...
%% Movie of parcels moving through the network 2-D
%set timestep to plot
t = 1;
nttl = '';%Parcel input to all 1st order links of the Watonwan River network';
...
%ylim([4.84*10^6 4.9*10^6])
%xlim([3.2*10^5 4.1*10^5])
...
nt1=text(4.39e+05,4.783e+06,'Czuba et al., 2015','Color',[0.5 0.5 0.5]);
...
for t=2:1:timesteps%700%1850%1034%1782%LS-932%W-1034
    
    %plot parcels on network at current time step
    Plot_Network_Parcels_Size2
